...
<h2>${title}</h2>
<p>${body}</p>
<p>中国企业财务管理协会（简称"中财协"）是经国务院批准、民政部登记注册的非营利性全国性社会团体，是代表中国企业财务管理领域最高水平的行业协会。</p>
...
export const ARTICLES: Article[] = [
  {
    ...
    summary: '根据《中国企业财务管理协会团体标准管理办法》有关规定，现对《企业数据资产管理规范》团体标准予以立项公告。',
    content: articleContent(
      '关于《企业数据资产管理规范》团体标准立项公告',
      '根据《中国企业财务管理协会团体标准管理办法》有关规定，经标准化委员会审查，现对《企业数据资产管理规范》团体标准予以立项。请各有关单位积极参与标准制定工作。'
    ),
    categorySn: 705750,
    categoryName: '标准立项',
  ...
  {
    id: 1002,
    title: '中国企业财务管理协会2025年度会员大会顺利召开',
    summary: '大会总结了2024年工作成果，部署了2025年重点工作任务。',
    content: articleContent(
      '2025年度会员大会顺利召开',
      '2025年3月28日，中国企业财务管理协会2025年度会员大会在北京国际财经中心顺利召开。来自全国各地的会员代表200余人参加了会议。'
    ),
    categorySn: 1301,
    categoryName: '协会动态',
  ...
  },
  {
    ...
    summary: '中国企业财务管理协会与IAB联合开展财务管理人员能力验证，共建高层次国际人才服务平台。',
    content: articleContent(
      '财务管理人员能力验证工作启动',
  ...
  },
  {
    id: 1005,
    title: '协会简介',
    summary: '中国企业财务管理协会是经国务院批准、民政部登记注册的非营利性全国性社会团体。',
    content: articleContent(
      '协会简介',
      '中国企业财务管理协会成立于2014年，是代表中国企业财务管理领域最高水平的行业协会。协会现有会员单位3000余家，个人会员50000余人。'
    ),
    categorySn: 7150,
    categoryName: '协会简介',
  ...
  },
  {
    id: 1006,
    title: '协会章程',
    summary: '本章程是中国企业财务管理协会的基本准则。',
    content: articleContent(
      '协会章程',
      '第一章 总则。本协会名称为中国企业财务管理协会，英文名称为China Enterprise Financial Management Association，缩写为EFMAC。'
    ),
    categorySn: 7151,
    categoryName: '协会章程',
    publishTime: '2024-01-01',
