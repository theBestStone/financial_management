...
export const NAV_LIST: NavItem[] = [
  ...
  },
  {
    ...
    categorySn: 70,
    children: [
      { categoryName: '标准化委员会', categorySn: 7052, isList: 0 },
      {
        categoryName: '标准政策文件',
        categorySn: 7055,
        children: [
  ...
  },
  {
    ...
    children: [
      { categoryName: '服务平台', categorySn: 7351 },
      {
        ...
        categorySn: 7355,
        children: [
          { categoryName: '财务管理师FM', categorySn: 735552, isList: 0 },
          { categoryName: '管理会计师MAA', categorySn: 735550, isList: 0 },
          { categoryName: '税务管理师CNTA', categorySn: 735557, isList: 0 },
          { categoryName: '企业财税合规师FTC', categorySn: 735558, isList: 0 },
          { categoryName: '财务BP数字化管理师FBP', categorySn: 735556, isList: 0 },
          { categoryName: '企业数据资产管理师EDAM', categorySn: 735559, isList: 0 },
          { categoryName: '人工智能财会应用技能认证AIFASC', categorySn: 735562, isList: 0 },
        ],
      },
      {
        categoryName: '联合评价',
        categorySn: 7357,
        children: [
          { categoryName: '国际注册会计师ICPA', categorySn: 735751, isList: 0 },
          { categoryName: '全球数字化会计师GDA', categorySn: 735752, isList: 0 },
          { categoryName: 'ESG 分析师联合认证项目', categorySn: 735750, isList: 0 },
          { categoryName: '国际会计高端人才素质提升项目', categorySn: 735753, isList: 0 },
        ],
      },
      {
        categoryName: '专业能力评价',
        ...
        children: [
          ...
          { categoryName: '数字化税务师', categorySn: 735955, isList: 0 },
        ],
      },
  ...
  },
  {
    ...
    categorySn: 72,
    children: [
      { categoryName: '会员发展和服务办法', categorySn: 7255, isList: 0 },
    ...
    children: [
      {
        ...
        categorySn: 7456,
        children: [
          { categoryName: '高端人才（原领军人才专家）', categorySn: 745659, isList: 0 },
  ...
  },
  {
    ...
    children: [
      ...
      { categoryName: '实施细则', categorySn: 7953, isList: 0 },
      {
        categoryName: '证书查询',
